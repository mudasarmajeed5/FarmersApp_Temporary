...
const Home = () => {
  {
    ...
    return (<>
      <div className="App">
        ...
        <h1 className='flex justify-center items-center gap-2 text-2xl py-3 text-white bg-green-800'><span>IntelliGrow</span><span className='animate-pulse'><FaLeaf /></span></h1>
        {/* Online App */}
        <div className="bg-background">
          ...
          <div className="grid grid-cols-2 px-4 my-11 gap-4">
            <div className="bg-card hover:from-green-500 cursor-pointer  bg-gradient-to-br from-green-300 to-green-200 shadow-2xl shadow-green-500 p-4 rounded-lg flex flex-col gap-1 justify-center items-center">
              ...
              <div className="text-sm flex gap-2 flex-col justify-center items-center">
                <a href='/info' className="p-2 rounded-lg underline-offset-4 underline font-semibold text-sm">Diseases</a>
                <a href='/upload' className="p-2 rounded-lg underline-offset-4 underline font-semibold text-sm">Find Cures</a>
              </div>
            </div>
